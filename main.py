...
def parse_certprofile():
    ...
    cert_profile_template = os.path.join(current_directory, 'template/certprofile_template.json')
...
def parse_endentity():
    ...
    endentity_profile_template = os.path.join(current_directory, 'template/endentity_profile_template.json')
